...
patientSchema.statics.signup=async function(name,dob,mobile,aadhar,email,bloodgroup,address,password,disease){
...
patientSchema.statics.login= async function(aadhar, password){
    if(!aadhar || !password){
        throw Error("All fields must be filled")
    }
